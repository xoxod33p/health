...
export const ROLE_PERMISSIONS: Record<string, readonly string[]> = {
  ...
  INHOUSE_STAFF: ['customer.view', 'customer.update', 'employee.view', 'sensor.view', 'sensor.create', 'sensor.update', 'sensor.assign', 'sensor.replace', 'report.view', 'notification.view'],
