...
export class CreateEmployeeDto {
  ...
  @IsEnum(['SUPER_ADMIN', 'COMPANY_ADMIN', 'MANAGER', 'HEALTHCARE_EMPLOYEE', 'STAFF', 'AUDITOR']) role!: string;
...
export class UpdateEmployeeDto {
  ...
  @IsOptional() @IsEnum(['SUPER_ADMIN', 'COMPANY_ADMIN', 'MANAGER', 'HEALTHCARE_EMPLOYEE', 'STAFF', 'AUDITOR']) role?: string;
  @IsOptional() @IsArray() @IsString({ each: true }) permissions?: string[];
